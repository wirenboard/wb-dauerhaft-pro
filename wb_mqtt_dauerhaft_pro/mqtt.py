...
Meta format (per WB conventions)::
    ...
    /devices/<id>/controls/<c>/meta  {"type","readonly","order","title":{...},"min","max"}
...
class WbDevice:
    ...
    def set_error(self, name, error):
        """Set/clear the control error meta flag ('r'/'w'/'p' or '' to clear)."""
        self._pub(f"{self._base}/controls/{name}/meta/error", error or "")
